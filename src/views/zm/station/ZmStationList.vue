<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('货站/仓库')">导出</a-button>
    ...
    <zm-station-modal ref="modalForm" @ok="modalFormOk"></zm-station-modal>
  </a-card>
</template>
...
<script>
  ...
  import ZmStationModal from './modules/ZmStationModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/zmexpress/zmStation/list",
          delete: "/zmexpress/zmStation/delete",
          deleteBatch: "/zmexpress/zmStation/deleteBatch",
          exportXlsUrl: "/zmexpress/zmStation/exportXls",
          importExcelUrl: "zmexpress/zmStation/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'leader',text:'负责人',dictCode:''})
